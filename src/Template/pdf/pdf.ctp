<div class="white-bg invoice">
	...
	<div class="row">
		...
		<div class="block">
			<?php if($type == 'devis'): ?>
				<h2 class="titles">Bon pour accord</h2>
				<p>À ........................................................... , le ..................... / ..................... / .....................</p>
				<p>Signature et cachet</p>
				<div class="signature"></div>
				<p>Qualité de signataire</p>
				<div class="quality"></div>
			<?php elseif(($type == 'factures' || $type == 'acomptes') && isset($action['rib'])): ?>
				<h2 class="titles">RIB</h2>
				<b class="m-r">IBAN :</b> <?= $action['rib']['iban'] ?><br>
				<b class="m-r">BIC :</b> <?= $action['rib']['bic'] ?><br>
				<b class="m-r">Titulaire :</b> <?= $action['rib']['titulaire'] ?> 
			<?php endif ?>
		</div>
	</div>
